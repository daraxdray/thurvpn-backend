...
const { getAllCountries, dwn, createVpn, getAllVpn,getAllFileVpn, deleteAllVpn,getVpnById,getVpnByQuery,deleteVpn,getRegionByQuery,
    updateRegion,createMultipleVpn, addRegions,addSingleRegion,getServerFile,deleteAllVpnWhere} = require('../controllers/vpn')
